...
public class Configuracao extends javax.swing.JFrame {
    ...
    public Configuracao(JdbcTemplate jdbcTemplate) {
        ...
        List<String> apenasTipo = new ArrayList<>();
        List<Integer> apenasIdMaq = new ArrayList<>();
    ...
    private void initComponents() {
        ...
        cbMaquina.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Máquina" }));
        ...
        cbEstado.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Desativado", "Ligado" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (update == 0){
            int inserir = jdbcTemplate1.update("inset into maquinacomponente(fkMaquina,fkComponente,ativado) values (?,?,?)", idMaquina, idComponente, estado);
